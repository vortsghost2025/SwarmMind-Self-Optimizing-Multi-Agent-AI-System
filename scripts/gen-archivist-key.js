...
const idDir = sToLocal('S:/Archivist-Agent/.identity');
...
fs.writeFileSync(sToLocal('S:/Archivist-Agent/.identity/public.pem'), publicKey);
fs.writeFileSync(sToLocal('S:/Archivist-Agent/.identity/private.pem'), privateKey);
...
const trustPath = sToLocal('S:/Archivist-Agent/lanes/broadcast/trust-store.json');
